...
public final class ProfileDisablement {
    ...
    public static final String SYSTEM_PROPERTY = "bluemap.chipped.disabledProfiles";
    public static final String ENVIRONMENT_VARIABLE = "BLUEMAP_CHIPPED_DISABLED_PROFILES";
